...
function Overivew() {
  return (
    <>
  <div className="flex flex-row nowrap items-center justify-start text-customGrey overflow-hidden relative pt-9 z-10 h-125 w-375 gap-0" style={{ height: '500px', width: '1500px' }}>
